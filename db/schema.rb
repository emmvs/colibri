...
ActiveRecord::Schema[7.0].define(version: 2023_10_12_095615) do
  ...
  create_table "preferences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["language_id"], name: "index_preferences_on_language_id"
  ...
  add_foreign_key "preferences", "languages"
